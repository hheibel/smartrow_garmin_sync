...
from smartrow_sync import SYNC_STATE_FILE
from smartrow_sync import format_filename

# Mock google.cloud before importing smartrow_sync
from smartrow_sync import get_last_synced_time
from smartrow_sync import sync_smartrow_activities
from smartrow_sync import update_last_synced_time
...
class TestSmartRowSync(unittest.TestCase):
    ...
    def test_get_last_synced_time_exists(self) -> None:
        ...
        mock_blob.download_as_text.return_value = (
            '{"last_synced_created": "2026-03-05T06:53:50.807Z"}'
        )
    ...
    def test_sync_smartrow_activities(
        self,
        mock_get_last_synced,
        mock_client_class,
        mock_storage_client_class,
        mock_upload_to_gcs,
        mock_update_last_synced,
    ) -> None:
        """
        ...
        mock_smartrow_client.get_activities.return_value = [
            ...
            },  # New
            {
                "id": 3,
                "public_id": "uuid-3",
                "created": "2026-03-05T06:53:50.807Z",
            },  # Newest
        ]
        ...
        mock_update_last_synced.assert_called_with(
            mock_bucket, "2026-03-05T06:53:50.807Z"
        )
